...
def fit_model_k_fold(X, y):
    ...
    params = {'max_depth':range(10,11),'criterion':np.array(['entropy','gini'])}
...
if __name__ == '__main__':
    ...
    data=mergeAllDevData(file0,mac_queue)

    fig = go.Figure()
    # Add traces
    fig.add_trace(go.Scatter(x=data.index, y=data.dev2,
                        mode='lines+markers',
                        name='dev2'))
    fig.add_trace(go.Scatter(x=data.index, y=data.dev5,
                        mode='lines+markers',
                        name='dev5'))
    fig.add_trace(go.Scatter(x=data.index, y=data.dev6,
                        mode='lines+markers',
                        name='dev6'))
    fig.show()
    ...
    fig = go.Figure()
    # Add traces
    fig.add_trace(go.Scatter(x=data.index, y=data.dev9,
                        mode='lines+markers',
                        name='dev9'))
    fig.add_trace(go.Scatter(x=data.index, y=data.dev10,
                        mode='lines+markers',
                        name='dev10'))
    fig.add_trace(go.Scatter(x=data.index, y=data.dev11,
                        mode='lines+markers',
                        name='dev11'))
    fig.show()
